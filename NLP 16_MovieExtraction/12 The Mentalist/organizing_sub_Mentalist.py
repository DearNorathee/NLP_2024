...
def make_lang_start_dict():
    ...
    lang_dict_lower['nob'] = 'Norwegian'
    lang_dict_lower['spa'] = 'Spanish_Latin America'
    lang_dict_lower['zho'] = 'Chinese_Traditional'
...
def main_orginizer():
    ...
    input_root_path = fr"C:\C_Video_Python\The Mentalist\The Mentalist Season {season_str}\Season {season_str} Subtitle\Amazon_temp"
    output_root_path = fr"C:\C_Video_Python\The Mentalist\The Mentalist Season {season_str}\Season {season_str} Subtitle"
