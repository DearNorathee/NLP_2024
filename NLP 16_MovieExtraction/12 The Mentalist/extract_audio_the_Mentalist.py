...
for season in range(1,13):
    season_str = str(season).zfill(2)
    # !CHANGE
    output_audio_folders[season] = fr"C:\C_Video_Python\The Mentalist\The Mentalist Season {season_str}\Season {season_str} Audio\Amazon_temp"
...
# took about 5 min per video
# about 2.5 hr per season(23 episodes)
