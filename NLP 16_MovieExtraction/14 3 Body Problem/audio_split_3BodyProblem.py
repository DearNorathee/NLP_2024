...
series_name:str = "3 Body Problem"
prefix:str = "3 Body Problem FR_"

#!Change
for season_int in range(1,4):
...
# took about 20 min for season1(8 EP)(in mp3)

#%%
for season in tqdm([1], desc= f"Season ",colour='#FFC000'):
    episode_names = ost.get_filename(input_audio_folder[season])
    n_episode = len(episode_names)
    # try:
    # for episode in range(1,n_episode+1):
